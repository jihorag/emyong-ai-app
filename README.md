...
```
화면 18개 렌더 · localStorage 키 8개 · AI 프롬프트 5종 바이트 대조
· 콘솔 에러 0 · 대시보드 수치 반응
```
...
| **전체 학습** | 13과목 → 단원 → 학습 방식 5가지. 논술 채점도 여기 |
| **AI 추천** | 기기에 쌓인 기록으로 오늘 볼 단원 3개를 고름 (AI 호출 없음) |
| **복습** | 오답노트 · 곧 다시 나올 카드 · 아직 안 외워진 것 |
| **학습 통계** | 공부 시간 · 캘린더 · 시기 가이드 · 공유 |

단원에 들어가면 학습 방식을 고릅니다 — **개념 읽기 · 기억 확인 · 개념 활용 · 스제트 연습 · 문제 풀기**.
...
4. **콘텐츠 저작권** — 단권화 노트가 상업 교재에서 왔습니다. 지식명제로 다시 쓰면서 정리해야 합니다
